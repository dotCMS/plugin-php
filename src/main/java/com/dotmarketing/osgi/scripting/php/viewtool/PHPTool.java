...
import com.dotmarketing.osgi.scripting.support.AbstractScriptingTool;
		...
		try {
			if(!canUserEvalute()){
				...
				if(UtilMethods.isSet(expression)){
					...
					return bsfUtil.evalExpression(LANGUAGE_PHP, expression);
				}
			...
			err = err.replaceAll("com.dotcms.repackage.bsf.org.apache.bsf.BSF", "");
